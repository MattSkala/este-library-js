...
/**
  ...
  @extends {este.Base}
*/
este.events.GestureHandler = function(element) {
  this.element = element;
  este.events.GestureHandler.superClass_.constructor.call(this);
  if (este.events.GestureHandler.CAN_USE_POLYMER) {
    este.events.GestureHandler.lazyInstallPolymerPointerGestures();
    this.registerPolymerPointerGesturesEvents();
    return;
  }
  this.on(this.element, 'click', this.onElementClick);
}
goog.inherits(este.events.GestureHandler, este.Base);

/**
  @enum {string}
*/
este.events.GestureHandler.EventType = {
  TAP: 'tap',
  SWIPELEFT: 'swipeleft',
...
/**
  ...
  @type {number}
*/
este.events.GestureHandler.prototype.swipeHorizontalThreshold = 75;

/**
  In pixels.
  @type {number}
*/
este.events.GestureHandler.prototype.swipeVerticalThreshold = 30;

/**
  In pixels.
  @type {number}
*/
este.events.GestureHandler.prototype.tapHysteresis = 10;

/**
  In miliseconds.
  @type {number}
*/
este.events.GestureHandler.prototype.tapholdThreshold = 750;

/**
  In miliseconds.
  @type {number}
*/
este.events.GestureHandler.prototype.doubleTapDurationThreshold = 200;

/**
  @type {Element}
  @protected
*/
este.events.GestureHandler.prototype.element = null;

/**
  @type {goog.events.BrowserEvent}
  @protected
*/
este.events.GestureHandler.prototype.trackStartEvent = null;

/**
  @type {goog.events.BrowserEvent}
  @protected
*/
este.events.GestureHandler.prototype.trackEndEvent = null;

/**
  @return {Element}
*/
este.events.GestureHandler.prototype.getElement = function() {
  return this.element;
};
...
/**
  ...
  @return {boolean}
*/
este.events.GestureHandler.prototype.targetIsTouchActionEnabled = function(node) {
  return !!goog.dom.getAncestor(node, function(item) {
    return item.hasAttribute && item.hasAttribute('touch-action');
  }, true);
};
...
/**
  @protected
*/
este.events.GestureHandler.prototype.registerPolymerPointerGesturesEvents = function() {
  this.on(this.element, 'pointerdown', this.onPointerDown);
  this.on(this.element, 'trackstart', this.onTrackStart);
  this.on(this.element, 'trackend', this.onTrackEnd);
  return this.on(this.element, 'tap', this.onTap);
};
...
/**
  ...
  @protected
*/
este.events.GestureHandler.prototype.onPointerDown = function(e) {
  this.trackStartEvent = null;
  return this.trackEndEvent = null;
};
...
/**
  ...
  @protected
*/
este.events.GestureHandler.prototype.onTrackStart = function(e) {
  return this.trackStartEvent = e;
};
...
/**
  ...
  @protected
*/
este.events.GestureHandler.prototype.onTrackEnd = function(e) {
  return this.trackEndEvent = e;
};
...
/**
  ...
  @protected
*/
este.events.GestureHandler.prototype.onTap = function(e) {
  var isTapWithoutTrack;
  isTapWithoutTrack = !this.trackStartEvent || !this.trackEndEvent;
  if (isTapWithoutTrack || this.isTapWithinHysteresis()) {
    return this.dispatchTapEvent(e.getBrowserEvent());
  } else if (this.isSwipe()) {
    return this.dispatchSwipeEvent();
  }
};
...
/**
  ...
  @protected
*/
este.events.GestureHandler.prototype.onElementClick = function(e) {
  var event;
  if (!this.targetIsTouchActionEnabled(e.target)) {
    return;
  }
  event = new este.events.GestureHandler.TapEvent(e.target, e.clientX, e.clientY);
...
/**
  ...
  @protected
*/
este.events.GestureHandler.prototype.isTapWithinHysteresis = function() {
  var distance, end, endCoordinate, start, startCoordinate;
  start = this.trackStartEvent.getBrowserEvent();
  end = this.trackEndEvent.getBrowserEvent();
  ...
  return distance < this.tapHysteresis;
};
...
/**
  ...
  @protected
*/
este.events.GestureHandler.prototype.dispatchTapEvent = function(polymerEvent) {
  var event, target;
  target = polymerEvent.target;
  event = new este.events.GestureHandler.TapEvent(target, polymerEvent['x'], polymerEvent['y']);
  return this.dispatchEvent(event);
};
...
/**
  ...
  @protected
*/
este.events.GestureHandler.prototype.isSwipe = function() {
  var polymerEvent;
  polymerEvent = this.trackEndEvent.getBrowserEvent();
  return Math.abs(polymerEvent['dx']) > this.swipeHorizontalThreshold || Math.abs(polymerEvent['dy']) > this.swipeVerticalThreshold;
};

/**
  @protected
*/
este.events.GestureHandler.prototype.dispatchSwipeEvent = function() {
  var endEvent, event, startEvent;
  startEvent = this.trackStartEvent.getBrowserEvent();
  endEvent = this.trackEndEvent.getBrowserEvent();
  event = new este.events.GestureHandler.SwipeEvent(startEvent, endEvent);
  return this.dispatchEvent(event);
};
...
*/
este.events.GestureHandler.TapEvent = function(target, x, y) {
  this.x = x;
  this.y = y;
  este.events.GestureHandler.TapEvent.superClass_.constructor.call(this, 'tap', target);
}
goog.inherits(este.events.GestureHandler.TapEvent, goog.events.Event);

/**
  @type {number}
*/
este.events.GestureHandler.TapEvent.prototype.x = 0;

/**
  @type {number}
*/
este.events.GestureHandler.TapEvent.prototype.y = 0;
...
/**
  ...
  @extends {goog.events.Event}
*/
este.events.GestureHandler.SwipeEvent = function(startPolymerEvent, endPolymerEvent) {
  var type;
  this.startPolymerEvent = startPolymerEvent;
  this.endPolymerEvent = endPolymerEvent;
  this.startClientX = this.startPolymerEvent['clientX'];
  this.startClientY = this.startPolymerEvent['clientY'];
  this.endClientX = this.endPolymerEvent['clientX'];
  this.endClientY = this.endPolymerEvent['clientY'];
  this.angle = goog.math.angle(this.startClientX, this.startClientY, this.endClientX, this.endClientY);
  type = este.events.GestureHandler.SwipeEvent.getEventTypeByAngle(this.angle);
  este.events.GestureHandler.SwipeEvent.superClass_.constructor.call(this, type, this.startPolymerEvent.target);
}
goog.inherits(este.events.GestureHandler.SwipeEvent, goog.events.Event);
este.events.GestureHandler.SwipeEvent.getEventTypeByAngle = function(angle) {
  if ((0 <= angle && angle <= 45) || (315 <= angle && angle <= 360)) {
    return este.events.GestureHandler.EventType.SWIPERIGHT;
  } else if ((135 <= angle && angle <= 225)) {
    return este.events.GestureHandler.EventType.SWIPELEFT;
  } else if ((45 < angle && angle < 135)) {
    return este.events.GestureHandler.EventType.SWIPEDOWN;
  } else {
    return este.events.GestureHandler.EventType.SWIPEUP;
  }
};
...
/**
  @type {Object}
*/
este.events.GestureHandler.SwipeEvent.prototype.startPolymerEvent = null;

/**
  @type {Object}
*/
este.events.GestureHandler.SwipeEvent.prototype.endPolymerEvent = null;

/**
  @type {number}
*/
este.events.GestureHandler.SwipeEvent.prototype.startClientX = 0;

/**
  @type {number}
*/
este.events.GestureHandler.SwipeEvent.prototype.startClientY = 0;

/**
  @type {number}
*/
este.events.GestureHandler.SwipeEvent.prototype.endClientX = 0;

/**
  @type {number}
*/
este.events.GestureHandler.SwipeEvent.prototype.endClientY = 0;

/**
  @type {number}
*/
este.events.GestureHandler.SwipeEvent.prototype.angle = 0;