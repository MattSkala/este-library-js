...
/**
  ...
  @return {string}
*/
este.router.Route.createUrl = function(path, params) {
  ...
  if (path.length > 1 && ((_ref = path.charAt(path.length - 1)) === '/' || _ref === '.')) {
    path = path.slice(0, -1);
  }
  return path;
};
...
/**
  ...
  @return {string}
*/
este.router.Route.prototype.createUrl = function(params) {
  if (params == null) {
    params = {};
  }
  return este.router.Route.createUrl(this.path, params);
};
