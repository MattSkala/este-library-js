...
goog.inherits(este.ui.FormsPersister, este.ui.Component);
...
este.ui.FormsPersister.prototype.retrieve = function(data) {
  var el, field, fields, fieldsMap, form, formPath, name, numberPath, stringPath, value, _i, _j, _k, _len, _len1, _len2, _name, _ref, _ref1, _ref2, _ref3;
  for (formPath in data) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      el = _ref[_i];
      if (fieldsMap[_name = el.name] == null) {
        fieldsMap[_name] = [];
      }
    ...
    for (name in fields) {
      value = fields[name];
      field = (_ref1 = fieldsMap[name]) != null ? _ref1[0] : void 0;
      if (!field) {
        continue;
      }
      switch (field.type) {
        case 'radio':
          _ref2 = fieldsMap[name];
