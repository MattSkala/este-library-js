...
goog.inherits(este.ui.Resizer, este.ui.Component);
...
este.ui.Resizer.prototype.enterDocument = function() {
  ...
  this.on(this.delegation, 'mouseover', this.onDelegationMouseOver);
  this.on(this.delegation, 'mouseout', this.onDelegationMouseOut);
};
...
este.ui.Resizer.prototype.onDelegationMouseOver = function(e) {
  ...
  this.on(this.handles, 'mouseout', this.onDelegationMouseOut);
  this.on(this.handles, 'start', this.onDragStart);
  this.on(this.handles, 'drag', this.onDrag);
  return this.on(this.handles, 'end', this.onDragEnd);
};
